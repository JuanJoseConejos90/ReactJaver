...
class companias extends Component {
    ...
    getAllCompanys() {
        try {
            ...
            user
                ...
                .then(data => {
                    setTimeout(() => {
                        this.setState({ companys: data.companys })
    ...
    renderTableHeader() {
        ...
        try {
            ...
            if (this.state.companys.length > 0) {
                let header = Object.keys(this.state.companys[0]);
    ...
    renderTableData() {
        ...
        try {
            ...
            if (this.state.companys.length > 0) {
                return this.state.companys.map((company, index) => {
                    return (
    ...
    renderRows(indice) {
        ...
        try {
            ...
            let header = Object.keys(this.state.companys[0]);
            return header.map((key, index) => {
                var value = (this.isDate(this.state.companys[indice][key]) ? this.parseMoment(this.state.companys[indice][key]) : this.state.companys[indice][key]);
    ...
    render() {
        ...
        return (
            <div className="container-fluid" data-panel="containerCompanys">
                        ...
                        <div className="card-header tittleContent">
                            <div className="row">
                                ...
                                <div className="col-1 pull-right">
                                    <button className="btn btn-primary"><Link to="./crearCompany">Nuevo</Link></button>
                                </div>
