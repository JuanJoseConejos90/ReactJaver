...
class localidades extends Component {
    ...
    renderTableHeader() {
        ...
        try {
            ...
            if (this.state.locations.length > 0) {
                let header = Object.keys(this.state.locations[0]);
    ...
    renderRows(indice) {
        ...
        try {
            ...
            let header = Object.keys(this.state.locations[0]);
            return header.map((key, index) => {
                var value = (this.isDate(this.state.locations[indice][key]) ? this.parseMoment(this.state.locations[indice][key]) : this.state.locations[indice][key]);
                var path = "/actualizarLocations/" + value;
                if (index === 0) {
                    return <td key={index}>
    ...
    render() {
        ...
        return (
            <div className="container-fluid" data-panel="containerLocalidades">
                        ...
                        <div className="card-header tittleContent">
                            <div className="row">
                                ...
                                <div className="col-1 pull-right">
                                    <button className="btn btn-primary"><Link to="./crearLocaciones">Nuevo</Link></button>
                                </div>
